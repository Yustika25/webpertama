...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" href="asset/images/kutu of book.png">
    <title>Kutu Of Book</title>
    ...
    <div>
      ...
      <div class="login_wrapper">
        ...
        <?php endif ?>
              ...
              <br />
              <div>
               <input type="submit" name="submit" class="btn btn-default submit" id="submit" value="Login"/>
              </div>

              <div class="clearfix"></div>

              <div class="separator">
                <p class="change_link">New Site?
